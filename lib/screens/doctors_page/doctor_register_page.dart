...
class _DoctorPageState extends State<DoctorPage> {
  ...
  Widget build(BuildContext context) {
    return Shortcuts(
      ...
      child: Actions(
        actions: {
          ActivateIntent:CallbackAction<ActivateIntent>(onInvoke: (intent)=>savedoctor()),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ElevatedButton(
                                  onPressed:savedoctor,style:ElevatedButton.styleFrom(backgroundColor: Colors.lightGreen
