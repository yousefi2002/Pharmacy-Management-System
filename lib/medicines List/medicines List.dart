...
class Medicines_List extends StatefulWidget {
  @override
  _Medicines_ListState createState() => _Medicines_ListState();
}

class _Medicines_ListState extends State<Medicines_List> {
              ...
              child: SingleChildScrollView(
                child: PaginatedDataTable(
                  ...
                  columns: [
                    ...
                    DataColumn(label: Text(AppLocalizations.of(context)!.trade_name)),
                    ...
                    DataColumn(label: Container(width:80,child: Text(AppLocalizations.of(context)!.manufacturer))),
                    DataColumn(label: Container(width:80,child: Text(AppLocalizations.of(context)!.barcode))),
...
class mydata extends DataTableSource {
  List<Map<String, String>> _prescriptions = [
    {"number": "1", "patient_name": "Patient A", "contact_number": "1234567890", "prescription_number": "RX0fasdf01", "total_amount": "1000", "paid_amount": "900"},
