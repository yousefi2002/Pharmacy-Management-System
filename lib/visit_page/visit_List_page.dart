...
class Visit_List_page extends StatefulWidget {
  @override
  _Visit_List_pageState createState() => _Visit_List_pageState();
}

class _Visit_List_pageState extends State<Visit_List_page> {
            ...
            Expanded(
              child: SingleChildScrollView(
                child: PaginatedDataTable(
                  ...
                  header: Center(child: Text(AppLocalizations.of(context)!.visit_list)),
                  columnSpacing: 130,
                  horizontalMargin: 40,
                ),
              ),
